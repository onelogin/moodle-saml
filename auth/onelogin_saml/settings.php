...
if ($ADMIN->fulltree) {
	...
	/* Description */
    $settings->add(new admin_setting_heading('auth_onelogin_saml/plugindescription',
            '',
            new lang_string('auth_onelogin_samldescription', 'auth_onelogin_saml', $CFG->wwwroot)));
	
    /* IDP */
    $settings->add(new admin_setting_heading('auth_onelogin_saml/pluginname',
	...
	/* Options */
	$settings->add(new admin_setting_heading('auth_onelogin_saml/options',
    ...
    /* Role Mapping */
	$settings->add(new admin_setting_heading('auth_onelogin_saml/rolemapping',
	...
	/* Advanced Settings */
	$settings->add(new admin_setting_heading('auth_onelogin_saml/advancedsettings',
